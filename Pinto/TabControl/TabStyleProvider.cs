...
namespace PintoNS.JacksonTabControl
{
	...
	public abstract class TabStyleProvider : Component
	{
		...
		protected bool _IgnoreImageOnTextDraw = false;
		...
		/// <summary>
		/// NOTE: The only supported alignments are the middle ones
		/// </summary>
		[Category("Appearance")]
		...
		[Category("Appearance")]
		public bool IgnoreImageOnTextDraw 
		{
			get { return this._IgnoreImageOnTextDraw; }
			set
			{
				this._IgnoreImageOnTextDraw = value;
				this._TabControl.Invalidate();
			}
		}
